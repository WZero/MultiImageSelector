    ...
    public void onCameraShot(File imageFile) {
        if (imageFile != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                String authority = String.format("%s.fileprovider", getApplicationContext().getPackageName());
                uri = FileProvider.getUriForFile(getApplicationContext(), authority, imageFile);
