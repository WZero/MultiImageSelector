            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        String authority = String.format("%s.fileprovider", getActivity().getApplicationContext().getPackageName());
                        uri = FileProvider.getUriForFile(getActivity().getApplicationContext(), authority, mTmpFile);
